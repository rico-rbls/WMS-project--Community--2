      ...
      <Card>
        ...
        <CardContent>
          ...
          <BulkDeleteDialog
            ...
            itemType="customer"
            itemNames={selectedCustomerNames}
            onConfirm={showArchived ? handleBulkPermanentDelete : handleBulkArchive}
            isLoading={isBulkDeleting}
            title={showArchived ? "Permanently Delete Customers" : "Archive Customers"}
            description={showArchived
              ? `Are you sure you want to permanently delete ${selectionCount} customer${selectionCount !== 1 ? "s" : ""}? This action cannot be undone.`
              : `Are you sure you want to archive ${selectionCount} customer${selectionCount !== 1 ? "s" : ""}? Archived customers can be restored later.`
            }
